...
export function Header() {
  ...
  const navItems = [
    { path: "/", icon: <ion-icon name="home-outline"></ion-icon>, label: "Inicio" },
    { path: "/contacto", icon: <ion-icon name="call-outline"></ion-icon>, label: "Contacto" },
    { path: "/extras", icon: <TbMassage className="text-5xl pt-5 mb-7" />, label: "Extras" },
    { path: "/reservas", icon: <ion-icon name="bed-outline"></ion-icon>, label: "Reservas" },
    { path: "/login", icon: <ion-icon name="person-outline"></ion-icon>, label: "Login/Registro" },
  ];
