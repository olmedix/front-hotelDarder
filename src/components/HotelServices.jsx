...
export function HotelServices() {
  ...
  return (
    <section className="w-full sm:w-2/3 mx-auto px-5 py-26 bg-[#fff] rounded-b-xl">
      ...
      <div className="overflow-x-auto text-gray-400 text-left text-lg mt-7">
        ...
        >
          {DESCRIPTION_HOTEL.map((hotels) => (
            <div className="xl:flex text-black text-left" key={hotels.id}>
              ...
              <div className="w-full xl:w-1/2 text-xl pb-3 px-5">
